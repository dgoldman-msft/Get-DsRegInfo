...
function Format-DsRegCmdOutput {
    <#
        ...
        .PARAMETER Input
            DSREGCMD output to be displayed
    ...
    process {
        ...
        if ($showAll) { foreach ($obj in $customObjects) { $obj } }
    }
}
...
function Get-DsRegInfo {
    <#
        ...
        .PARAMETER CleanAccounts
            Delete all WAM accounts

        .PARAMETER ListAllAccounts
            List all WAM accounts

        .PARAMETER UpdateDevice
            Update device attributes to Azure AD
    #>
